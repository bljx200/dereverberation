...
%      Version: $Id: fxpefac.m 2716 2013-02-23 09:32:37Z dmb $
%
...
for i=1:nframes
    [pos,peak]=findpeaks2(B(i,pfreq),[],5/(cf(pfreq(2))-cf(pfreq(1)))); % min separation = 5Hz @ fx=flim(1) (could pre-calculate) ====
    if numel(pos)
