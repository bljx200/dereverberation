...
% and get a 0-1 contour
    ...
    if max(ppdf)==0
        error('The cepstrum peak ratios of all frame are below threshold pthr1, since all frames are regarded to be unvoiced. For voiced/unvoiced or music/not music detection, please choose a smaller value for pthr1. pthr1 should be a value greater than or equal to 1');
    end
